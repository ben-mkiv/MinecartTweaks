...
public class ccDropItem implements ICartCommand {
    int workSlot = 0;

    @Override
    public boolean validate(String command){
        return command.equals("dropitem");
    }
    ...
    public void execute(AbstractMinecartEntity entity){
        ...
        MinecartUtils.dropItems(cart, workSlot, 1);
    }

    public ccDropItem create(ITextComponent[] signData){
        return new ccDropItem();
    }
