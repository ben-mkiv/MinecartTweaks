...
public class ccDropStack implements ICartCommand {
    int workSlot = 0;

    @Override
    public boolean validate(String command){
        return command.equals("dropstack");
    }
    ...
    public void execute(AbstractMinecartEntity entity){
        ...
        MinecartUtils.dropItems(cart, workSlot, 64);
    }

    public ccDropStack create(ITextComponent[] signData){
        return new ccDropStack();
    }
}
